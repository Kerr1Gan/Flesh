package com.ecjtu.ninjabrowser.fragment;
...
import com.ecjtu.ninjabrowser.activity.ClearActivity;
import com.ecjtu.ninjabrowser.activity.TokenActivity;
import com.ecjtu.ninjabrowser.activity.WhitelistActivity;
import com.ecjtu.ninjabrowser.task.ExportBookmarksTask;
import com.ecjtu.ninjabrowser.task.ExportWhitelistTask;
...
public class SettingFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (i == R.string.setting_title_token) {
            Intent toToken = new Intent(getActivity(), TokenActivity.class);
            getActivity().startActivity(toToken);

        } else if (i == R.string.setting_title_export_bookmarks) {
            new ExportBookmarksTask(getActivity()).execute();

        } else if (i == R.string.setting_title_import_bookmarks) {
        ...
        } else if (i == R.string.setting_title_clear_control) {
        ...
        } else if (i == R.string.setting_title_version) {
            NinjaToast.show(getActivity(), R.string.toast_emoji);

        } else if (i == R.string.setting_title_license) {
            showLicenseDialog();

        } else if (i == R.string.setting_title_donation) {
            showDonationDialog();
